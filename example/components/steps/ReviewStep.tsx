...
export const ReviewStep: React.FC<ReviewStepProps> = observer(
  ({ store, onComplete }) => {
          ...
          {errors.personalInfo ? (
            ...
            <>
              ...
              <Text style={styles.value}>
                {wizardData.personalInfo?.firstName}{' '}
          ...
          {errors.contactInfo ? (
            ...
            <>
              ...
              <Text style={styles.value}>
                ...
                {wizardData.contactInfo?.city}, {wizardData.contactInfo?.state}{' '}
                {wizardData.contactInfo?.zipCode}
              </Text>
            </>
          )}
        </View>
        ...
        <View style={styles.section}>
          ...
          {errors.security ? (
            ...
            <>
              ...
              <Text style={styles.value}>
                {wizardData.security?.securityQuestion}
              </Text>
            </>
          )}
        </View>
        ...
        <View style={styles.section}>
          ...
          {errors.preferences ? (
            ...
            <>
              ...
              <Text style={styles.value}>
                {wizardData.preferences?.language === 'en'
                  ? 'English'
                  : wizardData.preferences?.language === 'es'
                    ? 'Spanish'
                    : wizardData.preferences?.language === 'fr'
                      ? 'French'
                      : ''}
              </Text>
              ...
              <Text style={styles.value}>
                {wizardData.preferences?.theme === 'light'
                  ? 'Light'
                  : wizardData.preferences?.theme === 'dark'
                    ? 'Dark'
                    : ''}
              </Text>
              ...
              <Text style={styles.value}>
                {wizardData.preferences?.newsletter ? 'Yes' : 'No'}
              </Text>

              <Text style={styles.label}>Marketing Emails:</Text>
              <Text style={styles.value}>
                {wizardData.preferences?.marketing ? 'Yes' : 'No'}
              </Text>
            </>
          )}
        </View>
